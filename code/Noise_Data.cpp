...
/* This program functions the same as Noise.cpp. The only difference is that the name of the output image is the same as the input image.
...
void PoivreEtSel_G(char *cNomImgLue, char *cNomImgLueLocation, char* OutDir, float proportion)
{
    ...
    strcpy(cNomImgEcrite, std::string(std::string(OutDir) + cNomImgLue + std::string(".pgm")).c_str());
...
void PoivreEtSel_RGB(char *cNomImgLue, char *cNomImgLueLocation, char* OutDir ,float proportion)
{
    ...
    char cNomImgEcrite[250];
    strcpy(cNomImgEcrite, std::string(std::string(OutDir) + cNomImgLue + std::string(".ppm")).c_str());
